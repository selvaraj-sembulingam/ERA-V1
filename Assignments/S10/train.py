...
train_transforms = A.Compose([
    ...
    A.RandomCrop(32, 32),
    A.HorizontalFlip(),
    A.CoarseDropout(max_holes=1, max_height=8, max_width=8, min_holes=1, min_height=8, min_width=8, fill_value=(0.49139968, 0.48215827, 0.44653124)),  # Apply coarse dropout
